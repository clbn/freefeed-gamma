...
export const feedGeneratingActions = [HOME, DISCUSSIONS, DIRECT, GET_SUMMARY, GET_SEARCH_RESULTS, GET_USER_FEED, GET_USER_SUMMARY, GET_USER_COMMENTS, GET_USER_LIKES];
...
export const userChangeActions = [SIGN_UP, SIGN_IN, WHO_AM_I, SUBSCRIBE, UNSUBSCRIBE, UPDATE_USER, UPDATE_FRONTEND_PREFERENCES];
